...
class OptimusAttention(torch.nn.Module):
    ...
    def init_weights(self):
        initrange = 0.1
        torch.nn.init.uniform_(self.qkv_proj.weight.data,
                               -initrange, initrange)
        torch.nn.init.uniform_(self.out_proj.weight.data,
                               -initrange, initrange)
...
class Optimuslayer(torch.nn.Module):
    def __init__(self, embed_size: int,
        ...
        self.feedfw = torch.nn.Sequential(
            torch.nn.Linear(self.embed_size, self.fw_dim, bias=False), torch.nn.Linear(
                self.fw_dim, self.embed_size, bias=False),
...
class Optimus(torch.nn.Module):
    def __init__(self,
        ...
        self.vocab_classifier = torch.nn.Linear(embed_size,
    ...
    def init_weights(self):
        ...
        torch.nn.init.uniform_(
            self.embedding.weight.data, -initrange, initrange)
        torch.nn.init.uniform_(
            self.vocab_classifier.weight.data, -initrange, initrange)
